...
if(isset($_POST['order_btn'])){
   ...
   if($cart_query && $detail_query){
      ...
      $mail -> Body = 'Name:'.$_POST["name"].'Number:'.$_POST["number"].'Email:'.$_POST["email"].'Payment method:'.$_POST["method"].'Address:'.$_POST["flat"].$_POST["street"].$_POST["city"].$_POST["country"].$_POST["pin_code"].'Products:'.$total_product.'Total Price: '.$total_price;
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g. los angeles" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
         ...
         <div class="inputBox">
            <span>pin code</span>
            <input type="text" placeholder="e.g. 123342" name="pin_code" required>
         </div>
      </div>
